...
| ADMINISTRATION_CENTRALE | student:create, student:read, student:update, student:export, card:issue, card:suspend, card:revoke, card:verify, attendance:create, attendance:read, service:manage, service:verify, payment:create, payment:read, payment:reconcile, incident:create, incident:update, audit:read |
