ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    "DELEGATION_REGIONALE": {"student:read", "student:update", "student:archive", "card:verify", "attendance:read", "service:verify", "payment:read", "incident:create"},
    "DELEGATION_DEPARTEMENTALE": {"student:read", "student:update", "student:archive", "card:verify", "attendance:read", "service:verify", "payment:read", "incident:create"},
    "RESPONSABLE_ETABLISSEMENT": {"student:create", "student:read", "student:update", "student:archive", "card:verify", "attendance:create", "attendance:read", "service:manage", "service:verify", "payment:create", "payment:read", "incident:create"},
