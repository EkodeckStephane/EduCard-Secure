ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    "ADMINISTRATION_CENTRALE": {
        ...
        "incident:create", "incident:update", "audit:read", "dashboard:read", "export:create", "export:download",
    },
    "DELEGATION_REGIONALE": {"student:read", "student:update", "student:archive", "card:verify", "attendance:read", "service:verify", "payment:read", "incident:create", "dashboard:read", "export:create", "export:download"},
    "DELEGATION_DEPARTEMENTALE": {"student:read", "student:update", "student:archive", "card:verify", "attendance:read", "service:verify", "payment:read", "incident:create", "dashboard:read", "export:create", "export:download"},
    "RESPONSABLE_ETABLISSEMENT": {"student:create", "student:read", "student:update", "student:archive", "card:verify", "attendance:create", "attendance:read", "service:manage", "service:verify", "payment:create", "payment:read", "incident:create", "dashboard:read", "export:create", "export:download"},
    ...
    "AUDITEUR_SECURITE": {"audit:read", "audit:export", "incident:update", "dashboard:read", "export:create", "export:download"},
