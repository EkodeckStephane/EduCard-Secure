ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    "ADMINISTRATION_CENTRALE": {
        ...
        "privacy:read", "privacy:update", "backup:read", "security:read",
    },
    "DELEGATION_REGIONALE": {"student:read", "student:update", "student:archive", "card:verify", "attendance:read", "service:verify", "payment:read", "incident:create", "dashboard:read", "export:create", "export:download", "security:read"},
    "DELEGATION_DEPARTEMENTALE": {"student:read", "student:update", "student:archive", "card:verify", "attendance:read", "service:verify", "payment:read", "incident:create", "dashboard:read", "export:create", "export:download", "security:read"},
